...
<p>
	<ul style="list-style-type: none;">
		<li>
			<strong>Ngày:</strong> <?= date('d/m/Y', strtotime($fromDate)) ?> - <?= date('d/m/Y', strtotime($toDate)) ?>
		</li>
		<li>
			<strong>Đối tác:</strong> <?= $customer->name ?>
		</li>
	</ul>
</p>
<table width="100%">
	<thead>
		<tr class="text-center v-middle">
			...
			<th style="width:14%;"><strong>Ngày</strong></th>
			<th style="width:18%;"><strong>Sản phẩm</strong></th>
			<th style="width:11%;"><strong>Đơn giá<br>(đ/kg)</strong></th>
			<th style="width:12%;"><strong>Số lượng<br>(kg)</strong></th>
			<th style="width:14%;"><strong>Vận chuyển<br>(đ)</strong></th>
			<th style="width:15%;"><strong>Thành tiền<br>(đ)</strong></th>
			<th style="width:10%;"><strong>Ghi chú</strong></th>
		</tr>
	</thead>
	<tbody>
    	...
    	<?php else : ?>
            ...
            <?php foreach ($products as $key => $product) : ?>
                <tr>
                    ...
                    <td class="text-right" style="width:14%;"><?= date('d/m/Y', strtotime($product->order_date)) ?></td>
                    <td style="width:18%;"><?= $product->name ?></td>
                    <td class="text-right" style="width:11%;"><?= number_format($product->price, 0, '.', ',') ?></td>
                    ...
                    <td style="width:10%;"><em><?= $product->ohp_note ?></em></td>
                </tr>
                <?php 
                	$total += $money;
